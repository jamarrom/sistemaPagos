...
var internals_1 = require("@aws-amplify/pubsub/internals");
...
var InternalGraphQLAPIClass = /** @class */ (function () {
                ...
                switch (_l.label) {
                    ...
                    case 7:
                        headers = tslib_1.__assign.apply(void 0, [tslib_1.__assign.apply(void 0, [tslib_1.__assign.apply(void 0, _j.concat([(_l.sent())])), additionalHeaders]), (!customGraphqlEndpoint && (_k = {},
                                _k[USER_AGENT_HEADER] = core_1.getAmplifyUserAgentString(customUserAgentDetails),
                                _k))]);
                        body = {
    ...
    InternalGraphQLAPIClass.prototype._graphqlSubscribe = function (_a, additionalHeaders, customUserAgentDetails) {
        ...
        if (internals_1.InternalPubSub && typeof internals_1.InternalPubSub.subscribe === 'function') {
            return internals_1.InternalPubSub.subscribe('', {
...
core_1.Amplify.register(exports.InternalGraphQLAPI);
