...
export var createS3Client = function (config, storageAction, emitter) {
    ...
    var s3client = new S3Client(__assign(__assign({ region: region, 
        ...
        credentials: credentialsProvider, customUserAgent: getAmplifyUserAgent({
            category: Category.Storage,
            action: storageAction,
        }) }, localTestingConfig), { requestHandler: new AxiosHttpHandler({}, emitter, cancelTokenSource), useAccelerateEndpoint: useAccelerateEndpoint }));
