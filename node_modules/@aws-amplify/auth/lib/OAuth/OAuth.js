...
var oAuthStorage = tslib_1.__importStar(require("./oauthStorage"));
...
var OAuth = /** @class */ (function () {
                ...
                switch (_c.label) {
                    case 0:
                        code = (url_1.parse(currentUrl).query || '')
                            ...
                            return (tslib_1.__assign(tslib_1.__assign({}, accum), (_b = {}, _b[k] = v, _b)));
                        }, { code: undefined }).code;
                        ...
                        oAuthTokenBody = tslib_1.__assign({ grant_type: 'authorization_code', code: code,
                            client_id: client_id,
                        ...
                        customUserAgentDetails = {
                            category: core_1.Category.Auth,
                            action: core_1.AuthAction.FederatedSignIn,
                        };
                        return [4 /*yield*/, fetch(oAuthTokenEndpoint, {
                                ...
                                headers: (_b = {
                                    ...
                                    _b[core_1.USER_AGENT_HEADER] = core_1.getAmplifyUserAgentString(customUserAgentDetails),
                                    _b),
                                body: body,
                            })];
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        urlParams = currentUrl
                            ? tslib_1.__assign(tslib_1.__assign({}, (url_1.parse(currentUrl).hash || '#')
                                .substr(1)
                                .split('&')
                    ...
                    case 1: return [2 /*return*/, tslib_1.__assign.apply(void 0, [tslib_1.__assign.apply(void 0, _a.concat([(_c.sent())])), { state: state }])];
                    case 2:
                        _b = [{}];
                        return [4 /*yield*/, this._handleImplicitFlow(currentUrl)];
                    case 3: return [2 /*return*/, tslib_1.__assign.apply(void 0, [tslib_1.__assign.apply(void 0, _b.concat([(_c.sent())])), { state: state }])];
    ...
    OAuth.prototype._generateChallenge = function (code) {
        var awsCryptoHash = new sha256_js_1.Sha256();
        awsCryptoHash.update(code);
        var resultFromAWSCrypto = awsCryptoHash.digestSync();
        var b64 = buffer_1.Buffer.from(resultFromAWSCrypto).toString('base64');
